document.addEventListener("DOMContentLoaded", function () {
  ...
  let langPage = document.querySelector('html').getAttribute('lang');
  postDate('dd.mm.yyyy',langPage, false)
});
...
function postDate(sa, countryName, isAbbreviated) {
  ...
  switch (countryName) {
    case 'pl': // Poland
      ...
      break;
    case 'gr': //greece
      months = ['ο Ιανουάριος', 'ο Φεβρουάριος', 'ο Μάρτιος', 'ο Απρίλιος', 'ο Μάιος', 'ο Ιούνιος', 'ο Ιούλιος', 'ο Αύγουστος', 'ο Σεπτέμβριος', 'ο Οκτώβριος', 'ο Νοέμβριος', 'ο Δεκέμβριος'];
      break;
  }
